...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 486.5, 252.0, 155.0, 16.0 ],
					"text" : "portal.send \"video - MBP2\" 7006"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 542.5, 282.0, 99.0, 20.0 ],
					"text" : "jit.window MBP2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 32.5, 433.0, 110.0, 20.0 ],
					"text" : "jit.window TVcam1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 218.0, 282.0, 99.0, 20.0 ],
					"text" : "jit.window MBP1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 79.0, 300.0, 36.0 ],
					"text" : "VIDEO MBP2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 548.0, 214.0, 88.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 338.0, 124.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 18.0, 348.0, 36.0 ],
					"text" : "portal.testSendCooper"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 389.0, 139.0, 36.0 ],
					"text" : "SOUND"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 73.0, 296.0, 36.0 ],
					"text" : "VIDEO MBP1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 389.0, 88.0, 36.0 ],
					"text" : "OSC"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 218.0, 214.0, 88.0, 16.0 ],
					"text" : "portal.viprEncode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 338.0, 605.0, 141.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 218.0, 244.0, 155.0, 16.0 ],
					"text" : "portal.send \"video - MBP1\" 7005"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.0, 432.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 12.0, 116.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 338.0, 489.0, 50.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 338.0, 432.0, 107.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 338.0, 464.0, 73.0, 16.0 ],
					"text" : "random 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 338.0, 552.0, 85.0, 16.0 ],
					"text" : "o.pack /random1"
				}
