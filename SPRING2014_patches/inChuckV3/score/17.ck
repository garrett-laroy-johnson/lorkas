...
[ 
  ...
  [66, accent, 0 * h_note, h_note], 
  [66, velocity, 1 * h_note, w_note], 
  [66, accent, 3 * h_note, h_note], 
  [66, velocity, 4 * h_note, h_note],
  [66, velocity, 5 * h_note, w_note]
] @=> int pulsePhrase[][]; 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 17);
