...
[ 
  ...
  [67, velocity, 3 * s_note, s_note],
  [67, velocity, 4 * s_note, s_note], 
  [67, velocity, 5 * s_note, s_note],
  [67, velocity, 6 * s_note, s_note], 
  [67, velocity, 7 * s_note, s_note],
  [67, velocity, 8 * s_note, s_note], 
  [67, velocity, 9 * s_note, s_note],
  [67, velocity, 10 * s_note, s_note], 
  [67, velocity, 11 * s_note, s_note],
  [67, velocity, 12 * s_note, s_note], 
  [67, velocity, 13 * s_note, s_note],
  [67, velocity, 14 * s_note, s_note], 
  [67, velocity, 15 * s_note, s_note],
  [67, velocity, 16 * s_note, s_note],
  // midi pitch, vol, start-ticks, dur-ticks 
  [64, accent, 0, s_note], 
  [66, velocity, 1 * s_note, s_note], 
  [67, velocity, 2 * s_note, s_note], 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 9);
