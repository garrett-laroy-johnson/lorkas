...
[ 
  ...
  [67, velocity, 0 * s_note, s_note], 
  [72, velocity, 1 * s_note, s_note], 
  [70, accent, 2 * s_note, e_note], 
  [67, velocity, 0 * s_note, s_note], 
  [72, velocity, 1 * s_note, s_note], 
  [70, velocity, 2 * s_note, e_note], 
  [67, accent, 0 * s_note, s_note], 
  [72, velocity, 1 * s_note, s_note], 
  [70, velocity, 2 * s_note, e_note], 
  [67, velocity, 0 * s_note, s_note], 
  [72, accent, 1 * s_note, s_note], 
  [70, velocity, 2 * s_note, e_note]
] @=> int pulsePhrase[][]; 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 11);
