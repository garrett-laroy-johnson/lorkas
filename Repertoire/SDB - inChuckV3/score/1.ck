...
[ 
  ...
  [64, velocity, 0, s_note], 
  [64, velocity, 1 * q_note, s_note], 
  [64, velocity, 2 * q_note, s_note], 
  [60, velocity, 3 * q_note, q_note], 
  [64, velocity, 4 * q_note, s_note], 
  [64, velocity, 5 * q_note, s_note], 
  [64, velocity, 6 * q_note, s_note], 
  [60, velocity, 7 * q_note, q_note] 
] @=> int pulsePhrase[][]; 
