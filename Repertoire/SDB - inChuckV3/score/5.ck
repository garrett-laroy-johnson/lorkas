...
[ 
  ...
  [67, velocity, 4 * s_note, w_note], 
  [64, velocity, 1 * s_note, s_note], 
  [60, velocity, 2 * s_note, s_note], 
  [64, velocity, 3 * s_note, s_note],
  [60, velocity, 4 * s_note, s_note], 
  [64, velocity, 5 * s_note, s_note],
  [60, velocity, 6 * s_note, s_note], 
  [64, velocity, 7 * s_note, s_note],
  [67, velocity, 8 * s_note, w_note],
  [0, 0, 1 * s_note, h_note]
] @=> int pulsePhrase[][]; 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 5);
