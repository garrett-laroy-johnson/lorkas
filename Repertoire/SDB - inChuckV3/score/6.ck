...
[ 
  ...
  [64, velocity, 4 * s_note, s_note], 
  [67, velocity, 5 * s_note, s_note], 
  [72, velocity, 6 * s_note, s_note],
  [64, accent, 8 * s_note, s_note], 
  [67, velocity, 9 * s_note, s_note], 
  [72, velocity, 10 * s_note, s_note], 
  [64, velocity, 12 * s_note, s_note], 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 6);
