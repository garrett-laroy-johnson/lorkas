...
[ 
  ...
  [66, velocity, 0 * h_note, w_note], 
  [66, velocity, 2 * h_note, w_note], 
  [64, velocity, 4 * h_note, s_note], 
  [66, velocity, 0 * s_note, s_note],
  [64, velocity, 1 * s_note, s_note],
  [66, velocity, 2 * s_note, s_note], 
  [64, velocity, 3 * s_note, s_note], 
  [66, velocity, 4 * s_note, w_note]
] @=> int pulsePhrase[][]; 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 18);
