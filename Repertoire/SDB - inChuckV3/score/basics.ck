...
[ 
  ...
  [72, velocity, 0, e_note], 
  [72, velocity, 1 * e_note, e_note], 
  [72, velocity, 2 * e_note, e_note], 
  [72, velocity, 3 * e_note, e_note], 
  [72, velocity, 4 * e_note, e_note], 
  [72, velocity, 5 * e_note, e_note], 
  [72, velocity, 6 * e_note, e_note], 
  [72, velocity, 7 * e_note, e_note] 
] @=> int pulsePhrase[][]; 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 1);
