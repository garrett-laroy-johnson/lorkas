...
[ 
  ...
  [73, velocity, 0 * s_note, s_note], 
  [73, velocity, 1 * s_note, s_note], 
  [70, velocity, 2 * s_note, s_note], 
  [70, velocity, 3 * s_note, s_note], 
  [66, velocity, 4 * s_note, s_note], 
  [66, velocity, 5 * s_note, s_note], 
  [73, velocity, 0 * s_note, s_note], 
  [73, velocity, 1 * s_note, s_note], 
  [70, velocity, 2 * s_note, s_note], 
  [70, velocity, 3 * s_note, s_note], 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 15);
