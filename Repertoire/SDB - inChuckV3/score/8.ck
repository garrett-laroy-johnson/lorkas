...
[ 
  ...
  [67, velocity, 2 * e_note, s_note], 
  [67, velocity, 3 * e_note, s_note], 
  [67, velocity, 4 * e_note, s_note], 
  [64, velocity, 5 * e_note, s_note],
  [66, velocity, 11 * s_note, s_note], 
  [67, velocity, 12 * s_note, s_note],
  [67, accent, 10 * e_note, s_note], 
  [67, velocity, 11 * e_note, s_note],
  [67, velocity, 12 * e_note, s_note],
  [0, 0, 1 * s_note, h_note]
] @=> int pulsePhrase[][]; 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 8);
