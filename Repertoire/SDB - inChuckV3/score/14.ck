...
[ 
  ...
  [73, velocity, 0 * e_note, e_note], 
  [70, velocity, 1 * e_note, e_note], 
  [66, velocity, 2 * e_note, e_note], 
  [73, velocity, 0 * e_note, e_note], 
  [70, velocity, 1 * e_note, e_note], 
  [66, velocity, 2 * e_note, e_note], 
  [73, velocity, 0 * e_note, e_note], 
  ...
  [66, velocity, 2 * e_note, e_note], 
  [73, velocity, 0 * e_note, e_note], 
  [64, velocity, 1 * e_note, w_note],
  [64, 0, 0 * e_note, e_note]
] @=> int pulsePhrase[][]; 
...
/// do the deed!!!
myPlayer.repeatPhrase(pulsePhrase, instrument, mainGain, repetitions, octave_shift, 14);
